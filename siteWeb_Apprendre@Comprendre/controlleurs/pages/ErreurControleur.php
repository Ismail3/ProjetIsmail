 ...
 */
class ErreurControleur extends AbstractControleur
{
...
//            echo "<br/> label : " . $label_enconding . " : " . strlen($label_enconding);
    ...
    public function displayErreur()
    {
        ...
        $widget = $widget . '<div>
                                <br/>';
        $widget = $widget . '<h4 class="w3-center"> Vous devez <b>être connecté </b> afin d\'accéder à cette fonctionnalité </h4 > ';
        $widget = $widget . '<ul> ';
        $widget = $widget . '<li> ';
        $widget = $widget . '<a href = "../../../index.php" > ';
        $widget = $widget . 'Accueil';
        $widget = $widget . '</a> ';
        $widget = $widget . '</li> ';
        $widget = $widget . '<li> ';
        $widget = $widget . '<a href = "../authentification/authentification.php" > ';
        $widget = $widget . 'Authentification';
        $widget = $widget . '</a> ';
        $widget = $widget . '</li> ';
        $widget = $widget . '</ul> ';
        $widget = $widget . '</div > ';
