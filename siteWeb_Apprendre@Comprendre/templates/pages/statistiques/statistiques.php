<?php
require_once(dirname(__FILE__) . '/../../../controlleurs/pages/StatistiquesControleur.php');
session_start();
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" href="../../../ressources/styles/template-statistiques.css">
...
$ctrl = new StatistiquesControleur();

$ctrl->displayNavBar();
$ctrl->displayHeader();
$ctrl->displayTopButton();
$ctrl->displayStatistiques();
$ctrl->displayFooter();
