<?php
require_once(dirname(__FILE__) . '/../../../controlleurs/pages/ErreurControleur.php');
session_start();
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" href="../../../ressources/styles/template-erreurs.css">
